...
class Ui_El_GUI_CLIENTO(object):
    def setupUi(self, El_GUI_CLIENTO):
        ...
        self.left_frame.setFrameShadow(QFrame.Shadow.Plain)
        ...
        self.time_qFrame = QFrame(self.main_groupB)
        self.time_qFrame.setObjectName(u"time_qFrame")
        self.time_qFrame.setMinimumSize(QSize(170, 0))
        self.time_qFrame.setMaximumSize(QSize(170, 90))
        self.horizontalLayout_10 = QHBoxLayout(self.time_qFrame)
        self.horizontalLayout_10.setSpacing(5)
        self.horizontalLayout_10.setObjectName(u"horizontalLayout_10")
        self.horizontalLayout_10.setContentsMargins(0, 0, 0, 0)
        self.HH = QHBoxLayout()
        self.HH.setObjectName(u"HH")
        self.HH_lcdN = QLCDNumber(self.time_qFrame)
        ...
        self.MM_lcdN = QLCDNumber(self.time_qFrame)
        ...
        self.verticalLayout_3.addWidget(self.time_qFrame, 0, Qt.AlignmentFlag.AlignHCenter)
        ...
        sizePolicy.setHeightForWidth(self.plugin_led_lineE_1.sizePolicy().hasHeightForWidth())
        self.plugin_led_lineE_1.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.plugin_led_lineE_2.sizePolicy().hasHeightForWidth())
        self.plugin_led_lineE_2.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.plugin_led_lineE_3.sizePolicy().hasHeightForWidth())
        self.plugin_led_lineE_3.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.plugin_led_lineE_4.sizePolicy().hasHeightForWidth())
        self.plugin_led_lineE_4.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.plugin_led_lineE_5.sizePolicy().hasHeightForWidth())
        self.plugin_led_lineE_5.setSizePolicy(sizePolicy)
        ...
        self.network_stat_line.setMinimumSize(QSize(170, 30))
        self.network_stat_line.setMaximumSize(QSize(170, 30))
        self.network_stat_line.setFrame(True)
        self.network_stat_line.setReadOnly(True)

        self.gridLayout.addWidget(self.network_stat_line, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.full_screen_toolB, 0, 0, 1, 1)
        ...
        self.right_frame.setMaximumSize(QSize(800, 580))
    ...
    def retranslateUi(self, El_GUI_CLIENTO):
        ...
        self.main_groupB.setTitle(QCoreApplication.translate("El_GUI_CLIENTO", u"EL GUI CLIENTO", None))
