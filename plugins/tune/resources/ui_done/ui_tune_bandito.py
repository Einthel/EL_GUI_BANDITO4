...
class Ui_tune_bandito(object):
    def setupUi(self, tune_bandito):
        ...
        self.output_device_save_toolB.setMinimumSize(QSize(50, 50))
        self.output_device_save_toolB.setMaximumSize(QSize(16777215, 50))
    ...
    def retranslateUi(self, tune_bandito):
        ...
        self.audio_device_01_groupB.setTitle(QCoreApplication.translate("tune_bandito", u"Audio device #1", None))
        self.audio_device_02_groupB.setTitle(QCoreApplication.translate("tune_bandito", u"Audio device #2", None))
        self.bluetooth_device_groupB.setTitle(QCoreApplication.translate("tune_bandito", u"Bluetooch device", None))
        self.mic_01_groupB.setTitle(QCoreApplication.translate("tune_bandito", u"Mic #1", None))
