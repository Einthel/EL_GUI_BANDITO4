...
class Ui_tune_cliento(object):
    ...
    def retranslateUi(self, tune_cliento):
        ...
        self.audio_device_01_groupB.setTitle(QCoreApplication.translate("tune_cliento", u"Audio device #1", None))
        self.audiD_01_toolB.setText(QCoreApplication.translate("tune_cliento", u"...", None))
        self.audio_device_02_groupB.setTitle(QCoreApplication.translate("tune_cliento", u"Audio device #2", None))
        self.audiD_02_toolB.setText(QCoreApplication.translate("tune_cliento", u"...", None))
        self.bluetooth_device_groupB.setTitle(QCoreApplication.translate("tune_cliento", u"Bluetooch device", None))
        self.bt_audiD_toolB.setText(QCoreApplication.translate("tune_cliento", u"...", None))
        self.mic_01_groupB.setTitle(QCoreApplication.translate("tune_cliento", u"Mic #1", None))
        pass
    # retranslateUi
